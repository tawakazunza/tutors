    ...
    if (isset($_POST["subjects"])) {
        ...
        if (empty(trim($_POST["subjects"]))) {
            ...
            if ($stmt = $conn->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    if ($stmt->num_rows > 0) {
                        $city_name_err = "This subject already exists.";
                    }
                } else {
        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($stmt->execute()) {
                ...
                $error_message = "Error deleting subject. Please try again.";
            }
            $stmt->close();
        }
            ...
            if ($stmt = $conn->prepare($sql)) {
                ...
                if ($stmt->execute()) {
                    ...
                    if ($stmt->num_rows > 0) {
                        ...
                        $update_sql = "UPDATE subjects SET name = ? WHERE id = ?";
...
<head>
    ...
    <!-- Title Page-->
    <title>Openclass | Manage Subjects</title>
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap/5.3.2/js/bootstrap.bundle.min.js"></script>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editCityModalLabel">Edit Subject</h5>
                ...
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="edit_city_name" class="form-label">Subject</label>
    ...
    <div class="modal fade" id="deleteCityModal" tabindex="-1" aria-labelledby="deleteCityModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="deleteCityModalLabel">Delete Subject</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>Are you sure you want to delete this Subject?</p>
                    <p><strong>Subject: </strong><span id="delete_city_name"></span></p>
                </div>
                <div class="modal-footer">
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
