...
<head>
    ...
    <!-- Title Page-->
    <title>Openclass | Nofications</title>
    ...
    <!-- END HEADER DESKTOP -->
                                        ...
                                        <div class="col-md-12">
                                            <div class="welcome2-inner m-t-60">
                                                <div class="welcome2-greeting">
                                                    ...
                                                    <p class="text-white">Check inbox for notifications .</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="page-container3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div style="background-color:#0F1E8A;" class="card-header d-flex justify-content-between align-items-center text-white">
                                                <h4 class="m-0 text-white">My Notifications</h4>
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="text-center py-5">
                                                    ...
                                                    <p class="text-muted">You'll see updates from administrators here</p>
                                                </div>
                                                <?php else: ?>
                                                <div class="list-group">
                                                    <?php foreach ($notifications as $notification): ?>
                                                    <div class="list-group-item notification-item <?= !$notification['is_read'] ? 'unread' : '' ?> <?= $notification['is_important'] ? 'important' : '' ?>">
                                                        <div class="d-flex w-100 justify-content-between">
                                                            ...
                                                            <small class="notification-date"><?= date('M j, Y H:i', strtotime($notification['created_at'])) ?></small>
                                                        </div>
                                                        <p class="mb-1"><?= nl2br(htmlspecialchars(substr($notification['message'], 0, 150))) ?><?= strlen($notification['message']) > 150 ? '...' : '' ?></p>
                                                        <div class="d-flex justify-content-between align-items-center mt-2">
                                                            <small class="text-muted">From: <?= htmlspecialchars($notification['admin_name']) ?></small>
                                                            <div>
                                                                <button class="btn btn-sm btn-primary" onclick="viewNotification(<?= $notification['id'] ?>)">
                                                                    Read More
                                                                </button>
                                                                <?php if (!$notification['is_read']): ?>
                                                                <a href="tutor-notifications.php?mark_read=<?= $notification['id'] ?>" class="btn btn-sm btn-outline-secondary ml-2">
                                                                    Mark as Read
                                                                </a>
                                                                <?php endif; ?>
                                                            </div>
                                ...
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <a href="#" id="markReadBtn" class="btn btn-primary">Mark as Read</a>
...
<script>
        function viewNotification(id) {
            $.ajax({
                url: 'get-tutor-notification.php',
                type: 'GET',
                data: {id: id},
                dataType: 'json',
                success: function(response) {
                    if(response.success) {
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            ${response.notification.is_read ? '<span class="badge badge-secondary ml-2">Read</span>' : '<span class="badge badge-primary ml-2">Unread</span>'}
                                        </div>
                                    </div>
                                    <div class="row">
                        ...
                        if(response.notification.is_read) {
                            ...
                            $('#markReadBtn').show();
                            $('#markReadBtn').attr('href', 'tutor-notifications.php?mark_read=' + id);
                        }
                        
                        $('#notificationModal').modal('show');
                        
                        // If shown and not yet read, mark as read automatically after a delay
                        if(!response.notification.is_read) {
                            setTimeout(function() {
                                $.get('tutor-notifications.php?mark_read=' + id);
